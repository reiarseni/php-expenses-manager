...
$GetAccountDount2 = "SELECT account.AccountName, - sum(bills.Amount) AS Amount FROM account, bills where account.AccountId=bills.AccountId AND bills.UserId= $UserId group by account.AccountName";
$Dount2 = mysqli_query($mysqli, $GetAccountDount2);
