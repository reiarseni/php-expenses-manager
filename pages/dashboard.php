                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <table class="table table-bordered table-hover table-striped">
                                            ...
                                            <tbody>
                                                 <?php  while($col = mysqli_fetch_assoc($Dount2)){ ?>
                                                <tr>
                                                    <td><?php echo $col['AccountName'];?></td>
                                ...
                                <div class="col-lg-12">
									<?php while($BudgetCols = mysqli_fetch_assoc($Budgets)) { 
                                        ...
                                        if ($Out && $Out!=0) {
                                            ...
                                            $Exceed = '<label class="label label-warning">No Budget</label>';
                                        }
                 ...
                 <div class="panel panel-red">
                   ...
                   <!-- /.panel -->
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            <div id="incomevsexpensemonth"></div>            
                        </div>
                        <!-- /.panel-body -->
                    </div>
                    <!-- /.panel -->
   ...
   <script>
    ...
    $(function() {
        ...
        data: [
            ...
            value: <?php  echo ($colsDounat['AmountExpense'] ?? '0')  ;?>
			},
			{
            label: "<?php echo 'Income '.$ColUser['Currency'];?>",
            value: <?php  echo ($colsDounat['AmountIncome'] ?? '0') ;?>
			},		
        ],
        resize: true
		});
        ...
        data: [
			{
            label: "<?php echo 'Expense '.$ColUser['Currency'];?>",
            value: <?php  echo ($ColsDounatMonth['AmountExpense'] ?? '0') ;?>
			},
			{
            label: "<?php echo 'Income '.$ColUser['Currency'];?>",
            value: <?php  echo ($ColsDounatMonth['AmountIncome'] ?? '0') ;?>
			},		
        ],
        resize: true
       });
