     ...
     <div id="page-wrapper">
            ...
            <div class="row">
						...
						<div class="col-lg-6">
							...
							<div class="panel panel-primary">
								<div class="panel-heading">
									<i class="fa fa-bar-chart-o fa-fw"></i> Calender 1
								</div>
						...
						<div class="col-lg-6">
							...
							<div class="panel panel-primary">
								<div class="panel-heading">
									<i class="fa fa-bar-chart-o fa-fw"></i> Calender 2
								</div>
								<div class="panel-body">
...
<script>
	...
	Morris.Donut({
        ...
        data: [
            ...
            value: <?php echo ($IncomeOverall ?? '0')  ;?>
            },
            {
            label: "<?php echo $Expenses .' '. $ColUser['Currency'];?>",
            value: <?php echo  ($BillsOverall ?? '0')  ;?>
            },	
       ],
        resize: true
    });
    ...
    Morris.Donut({
        ...
        data: [
            {
            label: "<?php echo $Incomes .' '. $ColUser['Currency'];?>",
            value: <?php echo ($IncomeThisMonth ?? '0') ;?>
            },
            {
            label: "<?php echo $Expenses .' '. $ColUser['Currency'];?>",
            value: <?php echo ($BillThisMonth ?? '0') ;?>
            },  
       ],
        resize: true
    });
